...
mirm.aov1 = aov(RT ~ nearness*distance + Error(SUBJECT / (nearness*distance)),
                data = mirm.long)
...
summ.mirm.aov1[["Error: SUBJECT:nearness:distance"]][[1]][["F value"]][[1]]

##@@ P-VALUE @@##
summ.mirm.aov1[["Error: SUBJECT:nearness:distance"]][[1]][["Pr(>F)"]][[1]]

##@@ SAMPLE SIZE @@##
nrow(mirm.data)

##@@ EFFECT SIZE @@##
sumsq.error <- summ.mirm.aov1[["Error: SUBJECT:nearness:distance"]][[1]][["Sum Sq"]][[2]]
sumsq.effect <- summ.mirm.aov1[["Error: SUBJECT:nearness:distance"]][[1]][["Sum Sq"]][[1]]
